...
\header{morten emmanuel }{schiøler}{konsulent@deloitte} % Your name and current job title/field
...
\item Fungerer som teknisk ekspert i ici-sel og Java generelt. 
\item Administrerer Git-repository til automatiserede browsertests. 
